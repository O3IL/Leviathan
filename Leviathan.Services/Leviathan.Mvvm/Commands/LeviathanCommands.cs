...
using Leviathan.Mvvm.Commands.Editing;
using Leviathan.Mvvm.ViewModels;
using Leviathan.Mvvm.Views;


namespace Leviathan.Mvvm.Commands
{
    public class LeviathanCommands
    {
        ...
        private static LeviathanCommands _commands = null;

        public LeviathanCommands() { }
        public LeviathanCommands(PasteCommand pasteCommand)
        {
            _commands = this;
